...
def calculate_average_imdb_score_by_category(movie_list, category_name):
    category_movies = [movie for movie in movie_list if movie["category"] == category_name]
...
print(f"Average IMDb score for the '{category_name}' category: {average_score}")